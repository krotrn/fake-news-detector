...
import { AlertTriangle, CheckCircle, HelpCircle, Search, ThumbsDown, ThumbsUp } from "lucide-react"
  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setResult({
        ...
        sources: [
          { name: "IPCC Climate Report 2023", url: "#" },
          { name: "NASA Sea Level Monitoring", url: "#" },
          { name: "National Geographic Climate Data", url: "#" },
        ],
      })
      ...
      case "questionable":
        return (
          <div className="flex flex-col items-center gap-2">
            ...
            <Badge className="text-sm px-3 bg-yellow-500 hover:bg-yellow-600">Questionable</Badge>
          </div>
        )
      case "verified":
        return (
          <div className="flex flex-col items-center gap-2">
            ...
            <Badge className="text-sm px-3 bg-green-500 hover:bg-green-600">Verified</Badge>
          </div>
        )
    }
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
              ...
              <TabsContent value="url">
                <form onSubmit={handleVerify} className="flex flex-col sm:flex-row gap-4">
                  <Input
                    ...
                    className="flex-1"
                  />
                  <Button type="submit" disabled={isVerifying || !url}>
              ...
              <TabsContent value="headline">
                <form onSubmit={handleVerify} className="flex flex-col sm:flex-row gap-4">
                  <Input
                    ...
                    className="flex-1"
                  />
                  <Button type="submit" disabled={isVerifying || !headline}>
                    {isVerifying ? "Verifying..." : "Verify"}
                  </Button>
                </form>
              </TabsContent>
          ...
          <Card className="mb-8">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center justify-center py-8">
                ...
                <h3 className="text-xl font-medium mb-2">Verifying content...</h3>
              ...
              <div className="flex flex-col items-center justify-center py-6 mb-6">
                ...
                <div className="w-full max-w-md mt-6">
                  ...
                  <div className="h-3 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                    <div
                      className={`h-full ${getStatusColor(result.status)} transition-all duration-500 ease-in-out`}
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold mb-4">How Our Verification Works</h2>
            <p className="text-muted-foreground mb-6">
              Our news verification system uses a combination of AI analysis, trusted source verification, and
              crowdsourced feedback to determine the credibility of news articles.
            </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Our AI system analyzes the content, language patterns, and claims made in the article.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    We cross-reference information with trusted sources and fact-checking organizations.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    User feedback helps improve our verification system and provides additional context.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-medium text-lg">How accurate is the verification?</h3>
                <p className="text-muted-foreground">
                  Our system achieves over 85% accuracy in identifying fake news, with continuous improvements through
                  machine learning and user feedback.
                </p>
              </div>
              <div>
                <h3 className="font-medium text-lg">Can I verify social media posts?</h3>
                <p className="text-muted-foreground">
                  Yes, you can verify social media posts by pasting the URL or copying the content into the headline
                  field.
                </p>
              </div>
              <div>
                <h3 className="font-medium text-lg">How can I contribute to the platform?</h3>
                <p className="text-muted-foreground">
                  You can contribute by providing feedback on verifications, submitting articles for review, and sharing
                  the platform with others.
                </p>
              </div>
            </div>
          </div>
